...
namespace epl{
    ...
    public:
        ...
        public:
            ...
            iterator_helper(vector<T>* parent,T* ptr){
                this->ptr = ptr;
                this->parent = parent;
                //this->parent2 = NULL;
            ...
            iterator_helper(const vector<T>* parent,T* ptr){
                this->ptr = ptr;
                this->parent = parent;
                //this->parent1 = NULL;
                it_version = parent->vector_version;
            ...
            iterator_helper(const iterator_helper<T>& rhs){
                rhs.check_invalid();
                ptr = rhs.ptr;
                index = rhs.index;
           ...
           //     result.ptr = ptr;
           //     result.index = index;
           //     result.it_version = it_version;
           //     result.it_reallocate = it_reallocate;
           //     result.flag = flag;
           //     result.parent = parent;
           //     return result;
           //  }
            
            iterator_helper& operator=(const iterator_helper& rhs){
                if(this!=&rhs){
                    rhs.check_invalid();
                    ptr = rhs.ptr;
                    index = rhs.index;
            ...
            iterator_helper& operator++(void) { // pre ++
            ...
            iterator_helper operator++(int) {  // post ++
                check_invalid();
                iterator_helper t{*this}; // make a copy
                operator++(); // increment myself
                return t;
            }
            iterator_helper operator+(difference_type k) {
                check_invalid();
            ...
            bool operator==(iterator_helper const& rhs) const {
                check_invalid();
                rhs.check_invalid();
            ...
            difference_type operator-(iterator_helper& rhs){
                check_invalid();
                rhs.check_invalid();
                return this->ptr - rhs.ptr;
            }
            ...
            void check_invalid() const{
               // auto parent = (parent2==NULL)?parent1:parent2;
            ...
            void update_flag(){
                 //  auto parent = (parent2==NULL)?parent1:parent2;
               // if(parent2==NULL) parent = parent1;
               // else parent = parent2;
